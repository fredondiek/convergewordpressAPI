...
//        List<NewsItemPlacement> placements  = new ArrayList<NewsItemPlacement>();
//        Edition edition = new Edition();
//        Outlet outlet = new Outlet();
//        edition.setId(Long.MIN_VALUE);
//        edition.setExpirationDate(null);
//        edition.setNumber(Integer.SIZE);
//        edition.setOpen(true);
//        edition.setOutlet(outlet);
//        edition.setPublicationDate(null);
//        edition.setPlacements(null);
//        NewsItem newsItem = new NewsItem();
//        newsItem.setAssigned(true);
//        newsItem.setId(Long.MIN_VALUE);
//        newsItem.setOutlet(outlet);
//        newsItem.setPlacements(placements);
